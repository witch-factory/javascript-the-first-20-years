...
| 이름                  | 소속                                | 역할/기여                                                                                                |
| :-------------------- | :---------------------------------- | :------------------------------------------------------------------------------------------------------- |
| Marc Andreessen       | NCSA <br /> Netscape                | Mosaic 웹 브라우저 개발자 <br /> Netscape 공동 창립자, Mocha를 위해 싸움                                 |
...
| Eric Bina             | NCSA <br /> Netscape                | Mosaic 웹 브라우저 개발자 <br /> Netscape 공동 창립자                                                    |
...
| Jim Clark             | Netscape                            | Silicon Graphics, Netscape 창립자                                                                        |
...
| Douglas Crockford     | Yahoo!, PayPal                      | JavaScript 전도사, ES4<sub>2</sub> 반대자, JSON "발견"                                                   |
...
| Jeff Dyer             | Nombas/self <br /> Macromedia/Adobe | ES4 지지자, ES3&ES4<sub>1</sub> 기여자 <br /> ActionScript3 컴파일러, ES4<sub>2</sub> 에디터 개발        |
| Brendan Eich          | Netscape <br /> Mozilla             | 최초 JavaScript 설계자 및 구현자 <br /> Mozilla CTO, ES4에 대한 노력 재시작, Harmony 기여자              |
| Cormac Flanagan       | Univ Cal Santa Cruz                 | 하이브리드 타입 시스템 전문가, ES4<sub>2</sub> 설계 팀                                                   |
...
| Lars Thomas Hansen    | Opera, Adobe                        | ES4<sub>2</sub> 편집자                                                                                   |
| Dave Herman           | Northeastern Univ <br /> Mozilla    | 박사과정, 프로그래밍 언어 의미론 학자, ES4<sub>2</sub> 설계 팀, 모듈을 포함한 많은 ES6 프로포절의 챔피언 |
| Graydon Hoare         | Mozilla                             | ES4<sub>2</sub> 설계 팀                                                                                  |
| Luke Hoban            | Microsoft                           | 2011년부터 Microsoft의 TC39 대표단 주도                                                                  |
...
| Bill Joy              | Sun                                 | 해커, Sun의 공동 창립자; Netscape와의 JavaScript 작업의 경영 스폰서                                      |
...
| Pratap Lakshman       | Microsoft                           | ES4<sub>2</sub> 반대자, ES5 에디터, ES5conform test suite 고안                                           |
...
| Clayton Lewis         | Netscape                            | Netscape JavaScript 팀의 첫번째 매니저                                                                   |
...
| Anh Nguyen            | Netscape                            | 1번째 TC39 회의에서 Netscape 대표                                                                        |
...
| Sam Ruby              | IBM                                 | ES5&ES6 기여자; 10진수 연산 프로토타입 제작                                                              |
| Alex Russell          | Dojo Foundation <br /> Google       | ES5 기여자, Google Chrome 웹 표준 주도; ES6 기여자                                                       |
...
| Herman Venter         | Microsoft                           | ES3&ES4<sub>1</sub> 기여자; JScript.net 개발자                                                           |
...
| Allen Wirfs-Brock     | Microsoft <br /> Mozilla            | ES4<sub>2</sub> 반대자; ES5/5.1 편집자, ES6 편집자                                                       |
